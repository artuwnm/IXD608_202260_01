...
$empty_product = (object)[
	"name"=>"Sprite",
	"description"=>"a kind of beverage",
	"price"=>"1.89",
	"category"=>"beverage",
	"thumbnail"=>"sprite_1.jpg",
	"images"=>"sprite.jpg",
	"quantity"=>"23"
];
...
$form = <<<HTML
 	...
 	<form method="post" action="{$_SERVER['PHP_SELF']}?id=$id&action=$createorupdate">
		...
		<div class="form-control">
			...
			<input class="form-input" name="product-quantity" id="product-quantity" type="Number" min="0" max="1000" step="1" value="$o->quantity" placeholder="Enter the Product Price">
		</div>
		<div class="form-control">
