...
<div class="display-flex">
    ...
    <div class="flex-stretch">
        ...
        <form action="cart_actions.php?action=delete-cart-item" method="post">
            ...
            <input type="submit" class="form-button inline" value="Delete" style="font-size:0.8em;background-color:var(--color-main-light)">
        </form>
    </div>
...
function recommendedCategory($cat,$limit=3) {
    $result = makeQuery(makeConn(),"SELECT * FROM `products` WHERE `category`='$cat' ORDER BY `price` DESC LIMIT $limit");
    recommendedProducts($result);
}
